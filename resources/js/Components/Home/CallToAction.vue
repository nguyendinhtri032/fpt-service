...
<template>
    ...
    <section id="call-to-action" class="call-to-action section">
        <div class=" section-title" data-aos="fade-up">
            ...
            <h4>{{ $t('message.internetService') }}</h4>
        </div><!-- End Section Title -->
        <div class="container" data-aos="fade-up" data-aos-delay="100" style="background-color: grey !important;">
            <div class="row content justify-content-center align-items-center position-relative">
                ...
                <div class="col-lg-3 col-xs-12 mt-2">
                    <div class="d-flex justify-content-center">
                        <img src="/images/lux-800-router.png" alt="lux-800-router.png"
                            style="width: 180px; height: auto;">
                        <img src="/images/Navy-Blue-Futuristic-Virtual-Technology-Banner-3.png"
                            alt="Navy-Blue-Futuristic-Virtual-Technology-Banner-3.png"
                            style="width: 180px; height: auto;">
                    </div>
                </div>
                <div class="col-lg-3 col-xs-12">
                    <ul>
                        <li><i class="bi bi-check-circle-fill"></i> Tặng 1 tháng cước</li>
                        <li><i class="bi bi-check-circle-fill"></i> Trang bị modem Wi-Fi 6</li>
                        <li><i class="bi bi-check-circle-fill"></i> Trang bị AP Mesh Wi-Fi 6</li>
                        <li><i class="bi bi-check-circle-fill"></i> Công nghê Ultra Fast</li>
                        <li><i class="bi bi-check-circle-fill"></i> Hỗ trợ IP tĩnh</li>
                    </ul>
                </div>
